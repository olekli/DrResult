...
class Err[E: Exception](BaseResult[E]):
    ...
    def trace(self) -> str:
        tb_list = traceback.extract_tb(self._value.__traceback__)
        tb_list = [frame for frame in tb_list if frame.name != 'unwrap_or_raise']
        trace_to_print = ''.join(traceback.format_list(tb_list))
